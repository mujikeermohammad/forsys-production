...
<head>
    ...
    <title>Oracle Planning Central Cloud Deployment I Mfg I Case Study 
</title>
    <meta name=description content="Forsys implements Oracle Planning Central Cloud to optimize inventory mgmt for a cooler maker & achieves cost savings. 
">
    ...
    <style type="text/css">
        ...
        .hs-form-private .hs-form-field {
            margin-bottom: 15px;
                  ...
                  <body onselectstart="return false" ondragstart="return false" style="scroll-behavior: auto;background: #525659;display: flex;justify-content: center;">
                      <a href="../resources.php" class="btr" id="btr" style="display: none"><i class="bi bi-arrow-left"></i> Back to Resources</a>
    ...
    <h1 style="font-size: 0px">Resources</h1><br><object width="100%" height="10000px" id="obj" style="min-height: 102%; overflow: hidden" type="application/pdf" data="../case-studies/$1_M_Savings_by_Optimized_Inventory_Management_with_Oracle_Planning_Central_Cloud.pdf?#zoom=100&scrollbar=0&toolbar=0&navpanes=0">
    ...
    <!-- $1M Savings by Optimized Inventory Management with Oracle Planning Central Cloud  -->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><span class="modal-title-header">Case Studies</span>
                      Savings of $1 Million with Centralization & Optimization of Inventory Management</h4>
...
<![endif]-->
                    ...
                    <script>
                        hbspt.forms.create({
                            region: "na1",
                            portalId: "3988816",
                            formId: "75f5e9ee-cde6-4303-8e13-093d3aa9046f"
                        });
...
<script> const el = document.getElementById('btr');  setTimeout(() => {   el.style.display = 'block'; }, 10000); </script></body>
